...
class Wp_Bp_Follow_Common {
     ...
     */
    public function __construct($leader_id, $follower_id) {
    ...
    public function save() {
        ...
        $this->leader_id = apply_filters('wp_bp_follow_leader_id_before_save', $this->leader_id, $this->id);
        $this->follower_id = apply_filters('wp_bp_follow_follower_id_before_save', $this->follower_id, $this->id);

        do_action_ref_array('wp_bp_follow_before_save', array(&$this));
        ...
        do_action_ref_array('wp_bp_follow_after_save', array(&$this));
